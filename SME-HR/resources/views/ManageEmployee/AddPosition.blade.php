                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-pane show active px-7" id="kt_user_edit_tab_1" role="tabpanel">
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    <form method="POST" class="form form-horizontal" action="{{route('StorePosition')}}">
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input class="form-control border-primary" type="text" placeholder="Position Name" name="position_name" id="position_name">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
