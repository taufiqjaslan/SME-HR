...
Route::controller(App\Http\Controllers\EmployeeController::class)->group(function () {
    ...
    Route::get('/dashboardCount', 'count')->name('count');
});
...
Route::controller(App\Http\Controllers\ClaimController::class)->group(function () {
    ...
    Route::post('/updateClaimStatus/{id}', 'updateStatus')->name('updateStatus'); //update approve status
    Route::post('/updateClaimStatusReject/{id}', 'updateStatusReject')->name('updateStatusReject'); //update approve status
});
...
Route::controller(App\Http\Controllers\LeaveController::class)->group(function () {
    ...
    Route::post('/checkLeave', 'checkLeave')->name('checkLeave'); //link to check leave balance
    Route::post('/updateLeaveStatus/{id}', 'updateStatus')->name('updateStatus'); //update approve status
    Route::post('/updateLeaveStatusReject/{id}', 'updateStatusReject')->name('updateStatusReject'); //update approve status
    Route::get('/calendar/events', 'getEvents')->name('getEvents');
...
Route::controller(App\Http\Controllers\NotificationController::class)->group(function () {
    Route::get('/listNotification', 'listNotification')->name('listNotification'); //link to list of claim typepage
    Route::delete('/notifications/{id}', 'deleteNotification')->name('deleteNotification'); //link to delete the data from the database
    Route::delete('/notifications/delete-all', [NotificationController::class, 'deleteAll'])->name('deleteAll');
});
