<x-app-layout>
    <x-slot name="header_content">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="">Edit Claim</a></div>
        </div>
    </x-slot>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6" id="amount" @if ($claimInfo->claim_type_id == 3) hidden @endif>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input class="form-control border-primary" type="text" placeholder="Amount" name="amount" id="amount" value="{{ old('amount', $claimInfo->amount) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6" id="attachment" @if ($claimInfo->claim_type_id == 3) hidden @endif>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            ...
                                                            <input type="file" id="attachment_file" name="attachment" value="{{ old('attachment', $claimInfo->attachment) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
